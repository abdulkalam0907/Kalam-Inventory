...
<?php $__env->startSection('admin'); ?>
 ...
 <a href="<?php echo e(route('invoice.approve',$item->id)); ?>" class="btn btn-dark sm" title="Approved Data" >  <i class="fas fa-check-circle"></i> </a>

<a href="<?php echo e(route('invoice.delete',$item->id)); ?>" class="btn btn-danger sm" title="Delete Data" id="delete">  <i class="fas fa-trash-alt"></i> </a>
<?php endif; ?>  
</td>
...
<?php echo $__env->make('admin.admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Project2\m-supplies\resources\views/backend/invoice/invoice_pending_list.blade.php ENDPATH**/ ?>