    ...
    <div class="row">
        <div class="col-12">
            <div class="invoice-title">
                <h4 class="float-end font-size-16"><strong>Invoice No # <?php echo e($invoice->invoice_no); ?></strong></h4>
                <h3>
                ...
                <div class="col-6 mt-4 text-end">
                    <address>
                        <strong>Invoice Date:</strong><br>
                         <?php echo e(date('d-m-Y',strtotime($invoice->date))); ?> <br><br>
                    </address>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('admin.admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Project2\m-supplies\resources\views/backend/pdf/invoice_pdf.blade.php ENDPATH**/ ?>