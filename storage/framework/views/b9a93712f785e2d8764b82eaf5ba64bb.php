 ...
 <div class="page-content">
    ...
    <a href="<?php echo e(route('invoice.add')); ?>" class="btn btn-dark btn-rounded waves-effect waves-light" style="float:right;"><i class="fas fa-plus-circle"> Add Inovice </i></a> <br>  <br>               
            ...
            <tr>
                ...
                <td>
     <a href="<?php echo e(route('print.invoice',$item->id)); ?>" class="btn btn-danger sm" title="Print Invoice" >  <i class="fa fa-print"></i> </a>
                </td>
...
<?php echo $__env->make('admin.admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Project2\m-supplies\resources\views/backend/invoice/print_invoice_list.blade.php ENDPATH**/ ?>