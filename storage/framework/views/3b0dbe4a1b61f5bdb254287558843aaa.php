...
<form method="GET" action="<?php echo e(route('daily.invoice.pdf')); ?>" target="_blank" id="myForm">
    <div class="row">
...
<?php echo $__env->make('admin.admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Project2\m-supplies\resources\views/backend/invoice/daily_invoice_report.blade.php ENDPATH**/ ?>