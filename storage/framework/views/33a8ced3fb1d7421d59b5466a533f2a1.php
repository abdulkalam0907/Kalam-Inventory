...
<!--  /// Customer Credit Wise  -->
    <div class="show_credit" style="display:none">
        <form method="GET" action="<?php echo e(route('customer.wise.credit.report')); ?>" id="myForm" target="_blank" >
...
<div class="show_paid" style="display:none">
        <form method="GET" action="<?php echo e(route('customer.wise.paid.report')); ?>" id="myForm" target="_blank" >
...
<?php echo $__env->make('admin.admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Project2\m-supplies\resources\views/backend/customer/customer_wise_report.blade.php ENDPATH**/ ?>